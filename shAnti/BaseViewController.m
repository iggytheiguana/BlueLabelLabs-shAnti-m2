                 ...
                 inProgressMessages:(NSArray*)progressMessages
{
    ...
    shAntiAppDelegate* delegate =(shAntiAppDelegate*)[[UIApplication sharedApplication]delegate];
...
//            shAntiAppDelegate* profileViewController = [shAntiAppDelegate createInstance];
//            
    ...
    if (response.didSucceed) {
        ...
        if ([authnContext.isfirsttime boolValue]) {
            ...
            UICustomAlertView *alert = [[UICustomAlertView alloc]
                                        ...
                                        message:[NSString stringWithFormat:@"Hello %@! We've set up an account for you. Would you like to visit your profile and account settings, or continue from where you left off?", self.loggedInUser.firstname]
                                        delegate:self
